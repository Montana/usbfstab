...
**USBfstab** is an anti-forensic USB kill-switch that monitors connected USB devices and initiates secure shutdown procedures if an unauthorized change is detected.
